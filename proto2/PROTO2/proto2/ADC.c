...
/*************************** VARIABLES LOCALES ***************************/	
//Right
volatile INT16U	RIGHT_Vmax_pos = 1023;
volatile INT16U	RIGHT_Vzero_pos = 0;
volatile INT16U	RIGHT_Vmax_neg = 1023;
volatile INT16U	RIGHT_Vzero_neg = 0;
//Left
volatile INT16U	LEFT_Vmax_pos = 1023;
volatile INT16U	LEFT_Vzero_pos = 0;
